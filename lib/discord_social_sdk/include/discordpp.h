...
public:
    ...
    /// SetPTTActive(false) is called.
    ///
    /// Defaults to no bin delay, but we recommend setting to 20ms, which is what Discord uses.
...
public:
    ...
    ///
    /// This is an experimental API which may be removed or changed in a future bin.
    ///
